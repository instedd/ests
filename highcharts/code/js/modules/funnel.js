        ...
        n("funnel", "pie", {
            ...
            animate: F, translate: function () {
                var b = function (a, b) {
                    ...
                    }, c = 0, e = this.chart, d = this.options, r = d.reversed, H = d.ignoreHiddenPoint, t = e.plotWidth, e = e.plotHeight,
                    p = 0, n = d.center, f = b(n[0], t), q = b(n[1], e), z = b(d.width, t), h, v, k = b(d.height, e), w = b(d.neckWidth, t), D = b(d.neckHeight, e), x = q - k / 2 + k - D, b = this.data, A, B, I = "left" === d.dataLabels.position ? 1 : 0, C, l, E, u, g, y, m;
                ...
                var b = this.data,
                    c = this.options.dataLabels.distance, e, d, r, n = b.length, t, p;
