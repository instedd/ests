...
(function (q) {
    ...
    (function (f) {
        ...
        var x = f.win.document, U = function () {
        }, V = f.Color, l = f.Series, d = f.seriesTypes, p = f.each, y = f.extend, W = f.addEvent, X = f.fireEvent, z = f.grep, u = f.isNumber, Y = f.merge, Z = f.pick, n = f.wrap, v = f.getOptions().plotOptions, G;
        ...
        p(["translate", "generatePoints", "drawTracker", "drawPoints", "render"], function (a) {
            function b(b) {
                ...
                if ((this.processedXData || this.options.data).length < (this.options.boostThreshold || Number.MAX_VALUE) || c)"render" === a && this.image && (this.image.attr({href: ""}), this.animate = null), b.call(this); else if (this[a + "Canvas"])this[a + "Canvas"]()
            }
        ...
        f.extend(l.prototype, {
            pointRange: 0, allowDG: !1, hasExtremes: function (a) {
                var b = this.options, c = this.xAxis &&
                ...
                var a = this, b = this.points, c, e;
                if (b)for (e = 0; e < b.length; e += 1)(c = b[e]) && c.graphic && (c.graphic = c.graphic.destroy());
                p(["graph", "area", "tracker"], function (b) {
                    a[b] && (a[b] = a[b].destroy())
                })
            }, getContext: function () {
                var a = this.chart, b = a.plotWidth, c = a.plotHeight, e = this.ctx, g = function (a, b, c, e, g, f, d) {
                ...
                this.image.attr({width: b, height: c});
                return e
                ...
                var a = this, b = a.options, c = a.chart, e = this.xAxis,
                    ...
                    m = c.options.loading, ga = a.requireSorting, Q, ha = b.connectNulls, R = !l, D, E, t, w, ia = a.fillOpacity ? (new V(a.color)).setOpacity(Z(b.fillOpacity, .75)).get() : a.color, S = function () {
                        ...
                        d += 1;
                        d === ca && (S(), d = 0);
                        L = {clientX: b, plotY: c, yBottom: e}
                    }, F = function (a, b, f) {
                        da && !H[a + "," + b] && (H[a + "," + b] = !0, c.inverted &&
                        (a = e.len - a, b = g.len - b), I.push({clientX: a, plotX: a, plotY: b, i: fa + f}))
                    };
                ...
                q(P ? a.data : l || p, function (b, f) {
                        var d, h, k, l = "undefined" === typeof c.index, m = !0;
                        if (!l) {
                            R ? (d = b[0], h = b[1]) : (d = b, h = n[f]);
                            O ? (R && (h = b.slice(1, 3)), k = h[0], h = h[1]) : P && (d = b.x, h = b.stackY, k = h - b.y);
                            b = null === h;
                            ga || (m = h >= z && h <= aa);
                            if (!b && d >= v && d <= x && m)if (d = Math.round(e.toPixels(d, !0)), ba) {
                                if (void 0 === t || d === A) {
                                    O || (k = h);
        ...
        l.prototype.getPoint = function (a) {
            var b = a;
            !a || a instanceof this.pointClass || (b = (new this.pointClass).init(this, this.options.data[a.i]), b.category = b.x, b.dist = a.dist, b.distX = a.distX, b.plotX = a.plotX, b.plotY = a.plotY);
            return b
        };
        n(l.prototype, "destroy", function (a) {
            var b = this, c = b.chart;
            c.hoverPoints && (c.hoverPoints =
                z(c.hoverPoints, function (a) {
                    return a.series === b
                }));
