 ...
 */
(function (f) {
    var i = f.seriesTypes, l = f.merge, t = f.extendClass, u = f.getOptions().plotOptions, v = function () {
    }, m = f.each, s = f.pick, n = f.Series, q = f.Color;
    ...
    i.treemap = t(i.scatter, l({
        ...
        getTree: function () {
            var a = this, b = 0, c = [], d = [], e, g = function (a) {
                m(c[a], function (a) {
                    c[""].push(a)
                })
        ...
        calculateArea: function (a, b) {
            var c = [], d, e = this, g = e.options, h = g.layoutAlgorithm,
                f = g.alternateStartingDirection, i = this.nodeMap[this.rootNode].level, o = 0, j, p = g.levelIsConstant ? a.level : a.level - i, k;
        ...
        alg_func_group: function (a, b, c, d) {
            ...
            this.lP = {
                ...
                nW: 0, nR: 0, lR: 0, aspectRatio: function (a, b) {
        ...
        alg_func_lowAspectRatio: function (a, b, c) {
            var d = [], e = this, g, h = {
                ...
                y: b.y,
                parent: b
            }, f = 0, i = c.length - 1, o = new this.alg_func_group(b.height, b.width, b.direction, h);
            m(c, function (c) {
        ...
        drawDataLabels: function () {
            ...
            m(a.points, function (d) {
                if (d.node.isVisible)if (c = a.levelMap[d.level], !d.isLeaf || c) {
                    b = void 0;
        ...
        drillTo: function () {
            ...
            m(a.points, function (b) {
                var c, d;
                if (b.node.isVisible && (f.removeEvent(b, "click"), b.graphic && b.graphic.css({cursor: "default"}), c = a.options.interactByLeaf ? a.drillToByLeaf(b) : a.drillToByGroup(b)))d = a.nodeMap[a.rootNode].name || a.rootNode, b.graphic &&
        ...
        showDrillUpButton: function (a) {
            ...
            if (c.text)a = c.text;
            this.drillUpButton ?
                this.drillUpButton.attr({text: a}).align() : (e = (d = c.theme) && d.states, this.drillUpButton = this.chart.renderer.button(a, null, null, function () {
                b.drillUp()
