...
(function (c) {
    function o(d, a, b) {
        ...
        b ? (h = a.inverted, b = a.plotWidth / 2, a = a.plotHeight / 2, e = g.depth / 2, f = z(g.depth, 1) * z(g.viewDistance, 0)) : (b = a.plotLeft + a.plotWidth / 2, a = a.plotTop + a.plotHeight / 2, e = g.depth / 2, f = z(g.depth, 1) * z(g.viewDistance, 0));
        var j = [], i = b, k = a, v = e, q = f, b = w * (h ? g.beta : -g.beta), g = w * (h ? -g.alpha : g.alpha), p = l(b), s = m(b), t = l(g), u = m(g), x, C, r, o, n, y;
        c.each(d, function (a) {
            x = (h ? a.y : a.x) - i;
            C = (h ? a.x : a.y) - k;
            r = (a.z || 0) - v;
            ...
            y = p * u * x + s * u * r + t * C;
            q > 0 &&
            q < Number.POSITIVE_INFINITY && (o *= q / (y + v + q), n *= q / (y + v + q));
            o += i;
            n += k;
            y += v;
            j.push({x: h ? n : o, y: h ? o : n, z: y})
        });
        return j
    }
    ...
    function r(d, a, b, e, f, g, c, j) {
        var i = [];
        return g > f && g - f > p / 2 + 1.0E-4 ? (i = i.concat(r(d, a, b, e, f, f + p / 2, c, j)), i = i.concat(r(d, a, b, e, f + p / 2, g, c, j))) : g < f && f - g > p / 2 + 1.0E-4 ?
            (i = i.concat(r(d, a, b, e, f, f - p / 2, c, j)), i = i.concat(r(d, a, b, e, f - p / 2, g, c, j))) : (i = g - f, ["C", d + b * m(f) - b * A * i * l(f) + c, a + e * l(f) + e * A * i * m(f) + j, d + b * m(g) + b * A * i * l(g) + c, a + e * l(g) - e * A * i * m(g) + j, d + b * m(g) + c, a + e * l(g) + j])
    }
    ...
    function F(d) {
        if (this.chart.is3d()) {
            ...
            c.each(this.data, function (a) {
                if (a.y !== null)a = a.pointAttr, this.borderColor = c.pick(b.edgeColor, a[""].fill), a[""].stroke = this.borderColor, a.hover.stroke = c.pick(e.hover.edgeColor, this.borderColor), a.select.stroke = c.pick(e.select.edgeColor, this.borderColor)
            })
        }
        d.apply(this, [].slice.call(arguments, 1))
    }

    var p = Math.PI, w = p / 180, l = Math.sin, m = Math.cos, z = c.pick, G = Math.round;
    c.perspective = o;
    var A = 4 * (Math.sqrt(2) - 1) / 3 / (p / 2);
    ...
    c.SVGRenderer.prototype.cuboid = function (d) {
        ...
        a.attr = function (a) {
            a.shapeArgs || n(a.x) ? (a = this.renderer.cuboidPath(a.shapeArgs || a), this.front.attr({
                d: a[0],
                zIndex: a[3]
        ...
        a.animate = function (a, d, f) {
            n(a.x) && n(a.y) ? (a = this.renderer.cuboidPath(a), this.front.attr({zIndex: a[3]}).animate({d: a[0]},
    ...
    c.SVGRenderer.prototype.cuboidPath = function (d) {
        var a = d.x, b = d.y, e = d.z, f = d.height, g = d.width, h = d.depth, j = c.map, i = [{
            ...
            y: b,
            z: e + h
        }], i = o(i, c.charts[this.chartIndex], d.insidePlotArea), b = function (a, b) {
            a = j(a, function (a) {
                return i[a]
            });
            b = j(b, function (a) {
    ...
    c.SVGRenderer.prototype.arc3d = function (d) {
        ...
        a.animate = function (a, b, d) {
            n(a.end) || n(a.start) ? (this._shapeArgs = this.shapeArgs, c.SVGElement.prototype.animate.call(this,
                {_args: a}, {
    ...
    c.SVGRenderer.prototype.arc3dPath =
        function (d) {
            var a = d.x, b = d.y, e = d.start, c = d.end - 1.0E-5, g = d.r, h = d.innerR, j = d.depth, i = d.alpha, k = d.beta, v = m(e), q = l(e), d = m(c), o = l(c), s = g * m(k), t = g * m(i), u = h * m(k);
            h *= m(i);
            var x = j * l(k), n = j * l(i), j = ["M", a + s * v, b + t * q], j = j.concat(r(a, b, s, t, e, c, 0, 0)), j = j.concat(["L", a + u * d, b + h * o]), j = j.concat(r(a, b, u, h, c, e, 0, 0)), j = j.concat(["Z"]), k = k > 0 ? p / 2 : 0, i = i > 0 ? 0 : p / 2, k = e > -k ? e : c > -k ? -k : e, w = c < p - i ? c : e < p - i ? p - i : c, i = ["M", a + s * m(k), b + t * l(k)], i = i.concat(r(a, b, s, t, k, w, 0, 0)), i = i.concat(["L", a + s * m(w) + x, b + t * l(w) + n]), i = i.concat(r(a, b, s, t, w, k,
                x, n)), i = i.concat(["Z"]), k = ["M", a + u * v, b + h * q], k = k.concat(r(a, b, u, h, e, c, 0, 0)), k = k.concat(["L", a + u * m(c) + x, b + h * l(c) + n]), k = k.concat(r(a, b, u, h, c, e, x, n)), k = k.concat(["Z"]), v = ["M", a + s * v, b + t * q, "L", a + s * v + x, b + t * q + n, "L", a + u * v + x, b + h * q + n, "L", a + u * v, b + h * q, "Z"], a = ["M", a + s * d, b + t * o, "L", a + s * d + x, b + t * o + n, "L", a + u * d + x, b + h * o + n, "L", a + u * d, b + h * o, "Z"], b = l((e + c) / 2), e = l(e), c = l(c);
            return {
                top: j,
                zTop: g,
                out: i,
    ...
    c.wrap(c.Axis.prototype, "render", function (d) {
        d.apply(this, [].slice.call(arguments, 1));
        if (this.chart.is3d()) {
            var a = this.chart, b = a.renderer, c = a.options.chart.options3d, f = c.frame, g = f.bottom, h = f.back, f = f.side, j = c.depth, i = this.height, k = this.width, l = this.left, q = this.top;
            this.horiz ? (this.axisLine && this.axisLine.hide(), h = {
                x: l,
                y: q + (a.yAxis[0].reversed ? -g.size : i), z: 0, width: k, height: g.size, depth: j, insidePlotArea: !1
    ...
    c.wrap(c.Axis.prototype, "getPlotLinePath", function (c) {
        ...
        var b = this.chart.options.chart.options3d.depth, a = [{
            ...
            x: a[4], y: a[5],
            z: b
        }, {x: a[4], y: a[5], z: this.horiz || this.opposite ? 0 : b}], a = o(a, this.chart, !1);
    ...
    c.wrap(c.seriesTypes.column.prototype, "animate", function (d) {
        if (this.chart.is3d()) {
            ...
            if (c.svg)a ? c.each(e.data, function (a) {
                ...
                if (a.y !== null)a.shapeArgs.height = a.height, a.shapeArgs.y = a.shapey,
    ...
    c.wrap(c.Series.prototype, "alignDataLabel", function (c) {
        if (this.chart.is3d() && (this.type === "column" || this.type === "columnrange")) {
            var a = arguments[4], b = {x: a.x, y: a.y, z: this.z}, b = o([b], this.chart, !0)[0];
            a.x = b.x;
            a.y = b.y
        }
        c.apply(this, [].slice.call(arguments, 1))
    ...
    var B = c.getOptions();
    B.plotOptions.cylinder = c.merge(B.plotOptions.column);
    B = c.extendClass(c.seriesTypes.column,
        {type: "cylinder"});
    c.seriesTypes.cylinder = B;
        ...
        if (this.chart.is3d()) {
            ...
            c.each(a.data, function (b) {
                ...
                if (b.y)c.z = k, c.depth = f * 0.75, c.origin = h, c.alpha = j, c.beta = i, c = (c.end + c.start) / 2, b.slicedTranslation = {
                    translateX: G(m(c) * a.options.slicedOffset * m(j * w)),
                    translateY: G(l(c) * a.options.slicedOffset * m(j * w))
                }
            })
        }
    });
