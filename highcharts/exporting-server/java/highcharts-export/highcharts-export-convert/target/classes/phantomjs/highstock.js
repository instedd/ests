...
(function () {
    ...
    function V(a, b, c) {
        var d, e;
        if (Ja(b))r(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (r(b) && ia(b))for (d in b)a.setAttribute(d, b[d]);
        return e
    }
    ...
    function aa(a, b, c, d, e) {
        a = D.createElement(a);
        b && x(a, b);
        e && L(a, {padding: 0, border: Z, margin: 0});
        c && L(a, c);
        d && d.appendChild(a);
        return a
    }
    ...
    var s, D = document, S = window, X = Math, w = X.round, W = X.floor, za = X.ceil, v = X.max, B = X.min, Q = X.abs, ba = X.cos, ga = X.sin, va = X.PI, ra = va * 2 / 360, Ha = navigator.userAgent, Tb = S.opera, Ea = /(msie|trident)/i.test(Ha) && !Tb, nb = D.documentMode === 8, Gb = /AppleWebKit/.test(Ha), Va = /Firefox/.test(Ha), fb = /(Mobile|Android|Windows Phone)/.test(Ha), Ia = "http://www.w3.org/2000/svg", ea = !!D.createElementNS && !!D.createElementNS(Ia,
            "svg").createSVGRect, Yb = Va && parseInt(Ha.split("Firefox/")[1], 10) < 4, ma = !ea && !Ea && !!D.createElement("canvas").getContext, Wa, $a, Ub = {}, Hb = 0, lb, P, ka, Ga, Ib, H, ha = function () {
        return s
    }, ca = [], gb = 0, Ua = "div", Z = "none", Zb = /^[0-9]+$/, ob = ["plotTop", "marginRight", "marginBottom", "plotLeft"], $b = "stroke-width", fa, mb, ub, kb, yb, zb, Ab, cb, db, eb, Ob, Pb, Qb, Rb, Bb, Cb, Db, K = {}, A;
    ...
    ka = function (a, b, c) {
        ...
        var a = p(a, "%Y-%m-%d %H:%M:%S"), d = new fa(b - bb(b)), e, f = d[zb](), g = d[Ab](), h = d[cb](), i = d[db](), j = d[eb](), k = P.lang, m = k.weekdays, d = x({
            a: m[g].substr(0, 3),
            A: m[g],
            d: Ra(h),
            e: h,
    ...
    A.numberFormat = function (a, b, c, d) {
        var e = P.lang, a = +a || 0, f = b === -1 ? B((a.toString().split(".")[1] || "").length, 20) : isNaN(b =
            Q(b)) ? 2 : b, b = c === void 0 ? e.decimalPoint : c, d = d === void 0 ? e.thousandsSep : d, e = a < 0 ? "-" : "", c = String(C(a = Q(a).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
    ...
    var N = S.HighchartsAdapter, G = N || {};
    N && N.init.call(N, Ib);
    var pb = G.adapterRun, ac = G.getScript, Oa = G.inArray, n = A.each = G.each, hb = G.grep, bc = G.offset, Aa = G.map, E = G.addEvent, T = G.removeEvent, F = G.fireEvent, cc = G.washMouseEvent,
        qb = G.animate, ab = G.stop;
    P = {
    ...
    Nb();
    var dc = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, ec = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/, fc = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/,
        wa = function (a) {
            var b = [], c, d;
            (function (a) {
    ...
    Y.prototype = {
        ...
        applyTextShadow: function (a) {
            var b = this.element, c, d = a.indexOf("contrast") !== -1, e = this.renderer.forExport ||
                b.style.textShadow !== s && !Ea;
            d && (a = a.replace(/contrast/g, this.renderer.getContrast(b.style.fill)));
            e ? d && L(b, {textShadow: a}) : (this.fakeTS = !0, this.ySetter = this.xSetter, c = [].slice.call(b.getElementsByTagName("tspan")), n(a.split(/\s?,\s?/g), function (a) {
        ...
        css: function (a) {
            ...
            if (e) {
                ...
                if (Ea && !ea)L(this.element, a); else {
                    b = function (a, b) {
        ...
        zIndexSetter: function (a, b) {
            ...
            if (e) {
                ...
                d = c.childNodes;
                for (i = 0; i < d.length && !h; i++)if (e = d[i], f = V(e, "zIndex"), e !== g && (C(f) > a || !r(a) && r(f)))c.insertBefore(g, e), h = !0;
                h || c.appendChild(g)
            }
            return h
        },
    ...
    na.prototype = {
        Element: Y, init: function (a, b, c, d, e) {
            ...
            if (Va && a.getBoundingClientRect)this.subPixelFix = b = function () {
                ...
                L(a, {left: za(h.left) - h.left + "px", top: za(h.top) - h.top + "px"})
            }, b(), E(S, "resize", b)
        }, getStyle: function (a) {
            return this.style =
                x({
        ...
        buildText: function (a) {
            ...
            !f && !o && !q && e.indexOf(" ") === -1 ? b.appendChild(D.createTextNode(u(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, $ && $.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), n(e, function (e, f) {
                ...
                n(g, function (e) {
                    if (e !==
                        "" || g.length === 1) {
                        var o = {}, t = D.createElementNS(Ia, "tspan"), $;
                        h.test(e) && ($ = e.match(h)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), V(t, "style", $));
                        i.test(e) && !d && (V(t, "onclick", 'location.href="' + e.match(i)[1] + '"'), L(t, {cursor: "pointer"}));
                        e = u(e.replace(/<(.|\n)*?>/g, "") || " ");
                        if (e !== " ") {
                            ...
                            V(t, o);
                            b.appendChild(t);
                            !l && f && (!ea && d && L(t, {display: "block"}), V(t, "dy", z(t)));
                            if (m) {
            ...
            var j = this.label(a, b, c, i, null, null, null, null, "button"), k = 0, m, l, o, q, t, p, a = {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 1
            ...
            var e = ia(a) ? a.r : e, g = this.createElement("rect"), a = ia(a) ? a : a === s ? {} : {
                x: a,
                y: b,
                width: v(c, 0),
                height: v(d, 0)
            ...
            circle: function (a, b, c, d) {
                ...
                var f = e.start, c = e.r || c || d, g = e.end - 0.001, d = e.innerR, h = e.open, i = ba(f), j = ga(f), k = ba(g), g = ga(g), e = e.end - f < va ? 0 : 1;
            ...
            function j() {
                ...
                if (D) {
                    ...
                    t.isImg || t.attr(x({width: w(o.width), height: w(o.height)}, J));
                    J = null
                }
            }

            function k() {
                var a = o.styles, a = a && a.textAlign, b = M + u * (1 - z), c;
                c = h ? 0 : E;
                if (r(oa) && p && (a === "center" || a === "right"))b += {center: 0.5, right: 1}[a] * (oa - p.width);
            ...
            var l = this, o = l.g(i), q = l.text("", 0, 0, g).attr({zIndex: 1}), t, p, z = 0, u = 3, M = 0, oa, v, B, Jb, A = 0, J = {}, E, D;
            o.onAdd = function () {
                q.add(o);
                o.attr({text: a || a === 0 ? a : "", x: b, y: c});
                t && r(e) && o.attr({anchorX: e, anchorY: f})
            };
    ...
    x(Y.prototype, {
        htmlCss: function (a) {
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    var k = this.rotation, m, l = C(this.textWidth), o = [k, g, b.innerHTML, this.textWidth].join(",");
                    if (o !== this.cTT) {
            ...
            var d = {}, e = Ea ? "-ms-transform" : Gb ? "-webkit-transform" : Va ? "MozTransform" : Tb ? "-o-transform" : "";
                ...
                if (this.parentGroup = a) {
                    if (b = a.div, !b) {
                        ...
                        n(j.reverse(), function (a) {
                            var d;
                            b = a.div = a.div || aa(Ua, {className: V(a.element, "class")}, {
                                    position: "absolute",
    ...
    if (!ea && !ma)G =
    {
        ...
        L(this.element, {filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -c, ", M21=", c, ", M22=", b, ", sizingMethod='auto expand')"].join("") : Z})
        ...
        Element: G, isIE8: Ha.indexOf("MSIE 8.0") > -1, init: function (a, b, c, d) {
            var e;
            this.alignedObjects = [];
            ...
            if (i) {
                var k, m, l = a.linearGradient || a.radialGradient, o, q, t, p, z, u = "", a = a.stops, M, oa = [], s = function () {
                ...
                if (c === "fill")if (i === "gradient")c = l.x1 || l[0] || 0, a = l.y1 || l[1] || 0, o = l.x2 || l[2] || 0, l = l.y2 || l[3] || 0, u = 'angle="' + (90 - X.atan((l - a) / (o - c)) * 180 / va) + '"', s(); else {
                    var j = l.r, r = j * 2, w = j * 2, v = l.cx, x = l.cy, y = b.radialReference, B, j = function () {
            ...
            arc: function (a, b, c, d, e) {
                var f = e.start, g = e.end, h = e.r || c || d, c = e.innerR, d = ba(f), i = ga(f), j = ba(g), k = ga(g);
                if (g - f === 0)return ["x"];
                f = ["wa",
    ...
    Za.prototype = {
        addLabel: function () {
            var a = this.axis, b = a.options, c = a.chart, d = a.categories, e = a.names, f = this.pos,
                g = b.labels, h = a.tickPositions, i = f === h[0], j = f === h[h.length - 1], e = d ? p(d[f], e[f], f) : f, d = this.label, h = h.info, k;
            ...
            r(d) ? d && d.attr({text: b}) : (this.labelLength = (this.label = d = r(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(y(g.style)).add(a.labelGroup) : null) && d.getBBox().width, this.rotation = 0)
        },
        getLabelSize: function () {
            ...
            var b = this.axis, c = a.x, d = b.chart.chartWidth, e = b.chart.spacing, f = p(b.labelLeft, e[3]), e = p(b.labelRight, d - e[1]), g = this.label, h = this.rotation, i = {
                ...
                center: 0.5,
                right: 1
            }[b.labelAlign], j = g.getBBox().width, k = b.slotWidth, m;
            if (h)h < 0 && c - i * j < f ? m = w(c / ba(h * ra) - f) : h > 0 && c + i * j > e && (m = w((d - c) / ba(h * ra))); else {
                d = c - i * j;
                c += i * j;
                if (d < f)k -= f - d, a.x = f, g.attr({align: "left"}); else if (c > e)k -= c - e, a.x =
                    e, g.attr({align: "right"});
                if (j > k || b.autoRotation && g.styles.width)m = k
            }
            m && g.css({width: m, textOverflow: "ellipsis"})
            ...
            var i = this.axis, j = i.transA, k = i.reversed,
                m = i.staggerLines, l = i.tickRotCorr || {
                        x: 0,
                        y: 0
                    }, c = p(e.y, l.y + (i.side === 2 ? 8 : -(c.getBBox().height / 2))), a = a + e.x + l.x - (f && d ? f * j * (k ? -1 : 1) : 0), b = b + c - (f && !d ? f * j * (k ? 1 : -1) : 0);
            m && (b += g / (h || 1) % m * (i.labelOffset / m));
            return {x: a, y: w(b)}
        }, getMarkPath: function (a, b, c, d, e, f) {
            return f.crispLine(["M", a, b, "L", a + (e ? 0 : -c), b + (e ? c : 0)], d)
        }, render: function (a, b, c) {
            var d = this.axis, e = d.options, f = d.chart.renderer, g = d.horiz, h = this.type, i = this.label, j = this.pos, k = e.labels, m = this.gridLine, l = h ? h + "Grid" : "grid", o = h ? h + "Tick" : "tick", q = e[l + "LineWidth"],
                t = e[l + "LineColor"], n = e[l + "LineDashStyle"], z = e[o + "Length"], l = e[o + "Width"] || 0, u = e[o + "Color"], M = e[o + "Position"], o = this.mark, oa = k.step, r = !0, w = d.tickmarkOffset, v = this.getPosition(g, j, w, b), x = v.x, v = v.y, y = g && x === d.pos + d.len || !g && v === d.pos ? -1 : 1, c = p(c, 1);
            this.isActive = !0;
            if (q) {
                j = d.getPlotLinePath(j + w, q * y, b, !0);
                if (m === s) {
                    m = {stroke: t, "stroke-width": q};
                    if (n)m.dashstyle = n;
                    if (!h)m.zIndex = 1;
                    if (b)m.opacity = 0;
    ...
    A.PlotLineOrBand.prototype = {
        render: function () {
            var a = this, b = a.axis, c = b.horiz, d = a.options, e = d.label, f = a.label, g = d.width, h = d.to, i = d.from, j = r(i) && r(h), k = d.value, m = d.dashStyle, l = a.svgElem, o = [], q, t = d.color, p = d.zIndex, n = d.events, u = {}, M = b.chart.renderer;
            b.isLog && (i = La(i), h = La(h), k = La(k));
            if (g) {
                if (o = b.getPlotLinePath(k, g), u = {stroke: t, "stroke-width": g},
                        m)u.dashstyle = m
            } else if (j) {
            ...
            } else if (o && o.length && (a.svgElem = l = M.path(o).attr(u).add(), n))for (q in d = function (b) {
                l.on(b, function (c) {
                    n[b].apply(a, [c])
                })
            }, n)d(q);
    ...
    I.prototype = {
        ...
        defaultLabelFormatter: function () {
            var a = this.axis, b = this.value, c = a.categories, d = this.dateTimeLabelFormat, e = P.lang.numericSymbols, f = e && e.length, g, h = a.options.labels.format,
                a = a.isLog ? b : a.tickInterval;
            if (h)g = Ma(h, this); else if (c)g = b; else if (d)g = ka(d, b); else if (f && a >= 1E3)for (; f-- && g === s;)c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = A.numberFormat(b / c, -1) + e[f]);
        ...
        getPlotLinePath: function (a, b, c, d, e) {
            var f = this.chart, g = this.left, h = this.top, i, j, k = c && f.oldChartHeight || f.chartHeight, m = c && f.oldChartWidth || f.chartWidth, l;
            i = this.transB;
        ...
        unsquish: function () {
            var a = this.ticks, b = this.options.labels, c = this.horiz, d = this.tickInterval, e = d, f = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / d), g, h = b.rotation,
                i = this.chart.renderer.fontMetrics(b.style.fontSize, a[0] && a[0].label), j, k = Number.MAX_VALUE, m, l = function (a) {
                    a /= f || 1;
                    a = a > 1 ? za(a) : 1;
                    return a * d
                };
        ...
        renderUnsquish: function () {
            var a = this.chart, b = a.renderer, c = this.tickPositions, d = this.ticks, e = this.options.labels,
                f = this.horiz, g = a.margin, h = this.slotWidth = f && !e.step && !e.rotation && (this.staggerLines || 1) * a.plotWidth / c.length || !f && (g[3] && g[3] - a.spacing[3] || a.chartWidth * 0.33), i = v(1, w(h - 2 * (e.padding || 5))), j = {}, g = b.fontMetrics(e.style.fontSize, d[0] && d[0].label), k, m = 0;
            if (!Ja(e.rotation))j.rotation = e.rotation;
            if (this.autoRotation)n(c, function (a) {
                if ((a = d[a]) && a.labelLength > m)m = a.labelLength
            }), m > i && m > g.h ? j.rotation = this.labelRotation : this.labelRotation = 0; else if (h) {
        ...
        getOffset: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, j, k, m = 0, l, o = 0, q = d.title, t = d.labels, $ = 0, z = b.axisOffset, b = b.clipOffset, u = [-1, 1, 1, -1][h], M;
            ...
            if (!a.axisGroup)a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(), a.axisGroup = c.g("axis").attr({
                zIndex: d.zIndex ||
                2
            }).add(), a.labelGroup = c.g("axis-labels").attr({zIndex: t.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels").add();
            if (j || a.isLinked) {
                if (n(e, function (b) {
            ...
            } else for (M in f)f[M].destroy(), delete f[M];
        ...
        getTitlePosition: function () {
            var a = this.horiz, b = this.left, c = this.top, d = this.len, e = this.options.title, f = a ? b : c, g = this.opposite, h = this.offset, i = C(e.style.fontSize ||
                12), d = {
                low: f + (a ? 0 : d),
                middle: f + d / 2,
                high: f + (a ? d : 0)
        ...
        render: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.isLinked, g = a.tickPositions, h = a.axisTitle, i = a.ticks, j = a.minorTicks, k = a.alternateBands, m = d.stackLabels, l = d.alternateGridColor, o = a.tickmarkOffset, q = d.lineWidth, t, p = b.hasRendered && r(a.oldMin) && !isNaN(a.oldMin);
            t = a.hasData;
            var z = a.showAxis, u, M;
    ...
    I.prototype.getTimeTicks = function (a, b, c,
                                         d) {
        var e = [], f = {}, g = P.global.useUTC, h, i = new fa(b - bb(b)), j = a.unitRange, k = a.count;
        if (r(b)) {
    ...
    I.prototype.normalizeTimeTickInterval = function (a, b) {
        var c = b || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second",
                [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]], d = c[c.length - 1], e = H[d[0]], f = d[1], g;
    ...
    I.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (!d)this._minorAutoInterval =
            null;
        if (a >= 0.5)a = w(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = W(b), h, i, j, k, m, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
            i = e.length;
    ...
    Xa.prototype = {
        init: function (a, b) {
            ...
            var b = this.chart, c = b.series, d = b.tooltip, e = d ? d.shared : !1, f = b.hoverPoint, g = b.hoverSeries, h, i = b.chartWidth, j = b.chartWidth, k, m = [], l, o;
            ...
            if (l && (l !== f || d && d.isHidden))if (e && !l.series.noSharedTooltip) {
            ...
            var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, g = this.zoomVert, h = b.plotLeft, i = b.plotTop, j = b.plotWidth, k = b.plotHeight, m, l = this.mouseDownX, o = this.mouseDownY,
            ...
            if (this.hasDragged > 10) {
                ...
                g && (d = e - o, this.selectionMarker.attr({height: Q(d), y: (d > 0 ? 0 : d) + o}));
            ...
            a.originalEvent = a;
            a.cancelBubble = !0;
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (F(c.series, "click", x(a, {point: c})), b.hoverPoint && c.firePointEvent("click", a)) : (x(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && F(b, "click", a)))
    ...
    x(A.Pointer.prototype, {
        pinchTranslate: function (a, b, c, d, e, f) {
            ...
            var i = this.chart, j = a ? "x" : "y", k = a ? "X" : "Y", m = "chart" + k, l = a ? "width" : "height", o = i["plot" + (a ? "Left" : "Top")], q, t,
                p = h || 1, n = i.inverted, u = i.bounds[a ? "h" : "v"], M = b.length === 1, s = b[0][m], r = c[0][m], v = !M && b[1][m], w = !M && c[1][m], x, c = function () {
            ...
            var b = this, c = b.chart, d = b.pinchDown, e = a.touches,
                f = e.length, g = b.lastValidTouch, h = b.hasZoom, i = b.selectionMarker, j = {}, k = f === 1 && (b.inClass(a.target, "highcharts-tracker") && c.runTrackerClick || b.runChartClick), m = {};
            ...
            if (a.type === "touchstart")n(e, function (a, b) {
                ...
                if (a.zoomEnabled) {
                    var b = c.bounds[a.horiz ? "h" : "v"], d = a.minPixelPadding, e = a.toPixels(p(a.options.min,
                        a.dataMin)), f = a.toPixels(p(a.options.max, a.dataMax)), g = B(e, f), e = v(e, f);
                    b.min = B(a.pos, g - d);
                    b.max = v(a.pos + a.len, e + d)
                }
            }), b.res = !0; else if (d.length) {
                if (!i)b.selectionMarker = i = x({destroy: ha}, c.plotBox);
    ...
    if (S.PointerEvent || S.MSPointerEvent) {
        var Ba = {}, Lb = !!S.PointerEvent, gc = function () {
            var a, b = [];
            b.item = function (a) {
                return this[a]
            };
        ...
        R(Xa.prototype, "init", function (a, b, c) {
            a.call(this,
                b, c);
            this.hasZoom && L(b.container, {"-ms-touch-action": Z, "touch-action": Z})
        });
    ...
    rb.prototype = {
        ...
        destroy: function () {
            ...
            var b = this.chart, c = b.renderer, d = this.options, e = d.layout === "horizontal", f = this.symbolWidth, g = d.symbolPadding, h = this.itemStyle, i = this.itemHiddenStyle, j = this.padding, k = e ? p(d.itemDistance, 20) : 0, m = !d.rtl, l = d.width, o = d.itemMarginBottom || 0, q = this.itemMarginTop, t = this.initialItemX,
                n = a.legendItem, z = a.series && a.series.drawLegendSymbol ? a.series : a, u = z.options, u = this.createCheckboxForItem && u && u.showCheckbox, M = d.useHTML;
            if (!n) {
            ...
            var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding, g =
                e.maxHeight, h, i = this.clipRect, j = e.navigation, k = p(j.animation, !0), m = j.arrowSize || 12, l = this.nav, o = this.pages, q, t = this.allItems;
            ...
            if (a > f && !e.useHTML) {
                ...
                b.scroll(0);
                a = f
            } else if (l)i.attr({height: c.chartHeight}), l.hide(), this.scrollGroup.attr({translateY: 1}), this.clipHeight =
                0;
            return a
        }, scroll: function (a, b) {
    ...
    Pa.prototype =
    {
        ...
        var b = this.axes, c = this.series, d = this.pointer, e = this.legend, f = this.isDirtyLegend, g, h, i = this.hasCartesianSeries, j = this.isDirtyBox, k = c.length,
            m = k, l = this.renderer, o = l.isHidden(), q = [];
        Ya(a, this);
        ...
        var b = this, c = b.options.chart, d = b.renderTo, e = c.width || pb(d, "width"), f = c.height ||
            pb(d, "height"), c = a ? a.target : S, d = function () {
        ...
        (Ga ? qb : L)(d.container, {width: e + "px", height: f + "px"}, Ga);
        d.setChartSize(!0);
        ...
        if (l)g ? g.animate(g.crisp({
            ...
            "stroke-width": l, fill: Z, zIndex: 1
        }).add();
        this.isDirtyBox = !1
    ...
    O.prototype = {
        ...
        setData: function (a, b, c, d) {
            var e = this, f = e.points, g = f && f.length || 0, h, i = e.options, j = e.chart, k = null, m = e.xAxis, l = m && !!m.categories, o = i.turboThreshold, q = this.xData, t = this.yData, $ = (h = e.pointArrayMap) && h.length, a = a || [];
            h = a.length;
            b = p(b, !0);
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)n(a, function (a, b) {
                ...
                if (o && h > o) {
                    ...
                    if (sa(k)) {
                        ...
                        e.xIncrement = l
                    } else if (Ka(k))if ($)for (c = 0; c < h; c++)i = a[c], q[c] = i[0], t[c] = i.slice(1, $ + 1); else for (c = 0; c < h; c++)i = a[c], q[c] = i[0], t[c] =
                        i[1]; else qa(12)
                } else for (c = 0; c < h; c++)if (a[c] !== s && (i = {series: e}, e.pointClass.prototype.applyOptions.apply(i, [a[c]]), e.updateParallelArrays(i, c), l && i.name))m.names[i.x] = i.name;
                Ja(t[0]) && qa(14, !0);
                e.data = [];
                e.options.data = a;
        ...
        processData: function (a) {
            ...
            if (k && this.sorted && (!i || d > i || this.forceCrop))if (b[d - 1] < m || b[0] > l)b = [], c = []; else if (b[0] < m || b[d - 1] > l)e = this.cropData(this.xData, this.yData, m, l), b = e.xData, c = e.yData, e = e.start, f = !0;
        ...
        getExtremes: function (a) {
            ...
            d = a.length;
            for (m = 0; m < d; m++)if (j = c[m], k = a[m], i = k !== null && k !== s &&
                    (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.cropped || (c[m + 1] || j) >= g && (c[m - 1] || j) <= h, i && j)if (i = k.length)for (; i--;)k[i] !== null && (e[f++] = k[i]); else e[f++] = k;
            this.dataMin = Sa(e);
            this.dataMax = Fa(e)
        },
        translate: function () {
        ...
        drawPoints: function () {
            var a, b = this.points, c = this.chart, d, e, f, g, h, i, j, k, m = this.options.marker, l = this.pointAttr[""], o, q, t, n = this.markerGroup, z = p(m.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * m.radius);
            if (m.enabled !== !1 || this._hasPointMarkers)for (f = b.length; f--;)if (g = b[f], d = W(g.plotX), e = g.plotY, k = g.graphic, o = g.marker || {}, q = !!g.marker, a = z && o.enabled === s ||
                    o.enabled, t = g.isInside, a && e !== s && !isNaN(e) && g.y !== null)if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = p(o.symbol, this.symbol), j = i.indexOf("url") === 0, k)k[t ? "show" : "hide"](!0).animate(x({
                x: d - h,
                y: e - h
        ...
        getAttribs: function () {
            ...
            j = b.turboThreshold;
            var t = a.zones, p = a.zoneAxis || "y", z;
            ...
            if (!j || g < j || m)for (; g--;) {
                ...
                if (j.options)for (z in l)r(c[l[z]]) && (m = !0);
                if (m) {
                    c = c || {};
                    m = [];
                    d = c.states || {};
        ...
        applyZones: function () {
            var a = this, b = this.chart, c = b.renderer, d = this.zones, e, f, g = this.clips || [], h, i = this.graph, j = this.area, k = v(b.chartWidth, b.chartHeight), m = this[(this.zoneAxis || "y") + "Axis"], l = m.reversed, o = m.horiz, q = !1;
            if (d.length && (i || j))i && i.hide(), j && j.hide(), n(d, function (d, n) {
                ...
                if (m.isXAxis) {
                    if (h = {x: l ? f : e, y: 0, width: Math.abs(e - f), height: k}, !o)h.x = b.plotHeight -
                        h.x
                } else if (h = {x: 0, y: l ? e : f, width: k, height: Math.abs(e - f)}, o)h.y = b.plotWidth - h.y;
        ...
        searchKDTree: function (a) {
            function b(a, h, i, j) {
                var k = h.point, m = c.kdAxisArray[i % j], l, o = k;
                l = r(a[e]) && r(k[e]) ? Math.pow(a[e] - k[e], 2) : null;
                var q = r(a[f]) && r(k[f]) ? Math.pow(a[f] - k[f], 2) : null, t = (l || 0) + (q || 0);
                l = {
                    distX: r(l) ? Math.sqrt(l) : Number.MAX_VALUE, distY: r(q) ?
                        Math.sqrt(q) : Number.MAX_VALUE, distR: r(t) ? Math.sqrt(t) : Number.MAX_VALUE
                };
                k.dist = l;
                m = a[m] - k[m];
                l = m < 0 ? "left" : "right";
    ...
    O.prototype.setStackedPoints = function () {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            var a = this.processedXData, b = this.processedYData, c = [], d = b.length, e = this.options, f = e.threshold, g = e.stack, e = e.stacking,
                h = this.stackKey, i = "-" + h, j = this.negStacks, k = this.yAxis, m = k.stacks, l = k.oldStacks, o, q, t, p, n, u;
            for (p = 0; p < d; p++) {
                n = a[p];
                u = b[p];
                t = this.index + "," + p;
    ...
    x(Pa.prototype, {
        addSeries: function (a, b, c) {
            var d, e = this;
            a && (b = p(b, !0), F(e, "addSeries", {options: a}, function () {
                d = e.initSeries(a);
                e.isDirtyLegend = !0;
                e.linkSeries();
                b && e.redraw(c)
            ...
            new I(this, y(a, {index: this[e].length, isX: b}));
            f[e] = pa(f[e] || {});
            f[e].push(a);
            p(c, !0) && this.redraw(d)
            ...
            if (!d)b.loadingDiv = d = aa(Ua, {className: "highcharts-loading"}, x(e.style, {zIndex: 10, display: Z}),
    ...
    x(Ca.prototype, {
        update: function (a, b, c, d) {
            ...
            var f = this, g = f.series, h = f.graphic,
                i, j = g.chart, k = g.options, m = g.xAxis && g.xAxis.names, b = p(b, !0);
    ...
    x(O.prototype, {
        addPoint: function (a, b, c, d) {
            var e = this, f = e.options, g = e.data, h = e.graph, i = e.area, j = e.chart, k = e.xAxis && e.xAxis.names, m = h && h.shift || 0, l = ["graph", "area"], h = f.data, o, q = e.xData;
            Ya(d, j);
            if (c) {
    ...
    var Da = ja(O);
    K.line = Da;
    U.area = y(N, {threshold: 0});
    var ya = ja(O, {
        type: "area", getSegments: function () {
            var a = this, b = [], c = [], d = [], e = this.xAxis, f = this.yAxis, g = f.stacks[this.stackKey], h = {}, i, j, k = this.points, m = this.options.connectNulls, l, o;
            if (this.options.stacking && !this.cropped) {
                ...
                n(d, function (b) {
                    var d = 0, k;
                    if (!m ||
                        h[b] && h[b].y !== null)if (h[b])c.push(h[b]); else {
                        ...
                        i = e.translate(b);
                        j = f.toPixels(d, !0);
                        c.push({y: null, plotX: i, clientX: i, plotY: j, yBottom: j, onMouseOver: ha})
                    }
                });
                c.length && b.push(c)
    ...
    Da = ja(O, {
        ...
        getColumnMetrics: function () {
            ...
            var c = B(Q(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len), j = c * b.groupPadding, k = (c - 2 * j) / i, m = b.pointWidth, b = r(m) ? (k - m) / 2 : k * b.pointPadding, m = p(m, k - 2 * b);
        ...
        translate: function () {
            var a = this, b = a.chart, c = a.options, d = a.borderWidth = p(c.borderWidth, a.closestPointRange * a.xAxis.transA < 2 ? 0 : 1), e = a.yAxis, f = a.translatedThreshold = e.getThreshold(c.threshold), g = p(c.minPointLength,
                5), h = a.getColumnMetrics(), i = h.width, j = a.barW = v(i, 1 + 2 * d), k = a.pointXOffset = h.offset, m = -(d % 2 ? 0.5 : 0), l = d % 2 ? 0.5 : 1;
            b.inverted && (f -= 0.5, b.renderer.isVML && (l += 1));
            c.pointPadding && (j = za(j));
            O.prototype.translate.apply(a);
            n(a.points, function (c) {
                var d = p(c.yBottom, f), h = B(v(-999 - d, c.plotY), e.len + 999 + d), n = c.plotX + k, z = j, u = B(h, d), s, r;
                s = v(h, d) - u;
                ...
                d && (u -= 1, s += 1);
                c.shapeType = "rect";
                c.shapeArgs = {x: n, y: u, width: z, height: s}
            })
        },
        getSymbol: ha,
        drawLegendSymbol: G.drawRectangle,
        ...
        drawPoints: function () {
            ...
            n(a.points, function (h) {
                ...
                if (i !== s && !isNaN(i) && h.y !== null)f = h.shapeArgs, i = r(a.borderWidth) ? {"stroke-width": a.borderWidth} : {}, g = h.pointAttr[h.selected ?
                        "select" : ""] || a.pointAttr[""], j ? (ab(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](y(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius); else if (j)h.graphic = j.destroy()
            })
        },
        animate: function (a) {
    ...
    N = {
        ...
        pointClass: ja(Ca, {
            init: function () {
                ...
                if (a !== c.visible ||
                    b)if (c.visible = c.options.visible = a = a === s ? !c.visible : a, d.options.data[Oa(c, d.data)] = c.options, n(["graphic", "dataLabel", "connector", "shadowGroup"], function (b) {
        ...
        translate: function (a) {
            this.generatePoints();
            var b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, f, g, h, i = c.startAngle || 0, j = this.startAngleRad = va / 180 * (i - 90), i = (this.endAngleRad = va / 180 * (p(c.endAngle, i + 360) - 90)) - j, k = this.points, m = c.dataLabels.distance,
                c = c.ignoreHiddenPoint, l, o = k.length, q;
            ...
            for (l = 0; l < o; l++) {
                ...
                q.slicedTranslation = {translateX: w(ba(h) * d), translateY: w(ga(h) * d)};
                f = ba(h) * a[2] / 2;
                g = ga(h) * a[2] / 2;
                q.tooltipPos =
                    [a[0] + f * 0.7, a[1] + g * 0.7];
    ...
    O.prototype.drawDataLabels =
        function () {
            ...
            if (d.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(d), j = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) && (j.attr({opacity: +h}), h || E(a, "afterAnimate", function () {
                a.visible && j.show();
                j[b.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200})
            })), g = d, n(e, function (e) {
                var h, o = e.dataLabel, q, t, n = e.connector, z = !0, u, v = {};
                f =
                ...
                if (o && !h)e.dataLabel = o.destroy(); else if (h) {
                    ...
                    if (o)if (r(i))o.attr({text: i}), z = !1; else {
    ...
    O.prototype.alignDataLabel = function (a, b, c, d, e) {
        var f = this.chart, g = f.inverted, h = p(a.plotX, -999), i = p(a.plotY, -999), j = b.getBBox(), k = f.renderer.fontMetrics(c.style.fontSize).b, m = this.visible && (a.series.forceDL ||
        ...
        }).attr({align: c.align})) : (b.align(c, null, d), g = b.alignAttr, p(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, j, d, e) : p(c.crop, !0) && (m = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y +
    ...
    if (K.pie)K.pie.prototype.drawDataLabels = function () {
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth, 1), h = d.plotWidth, i = d.plotHeight, j, k, m = p(e.softConnector, !0), l = e.distance, o = a.center, q = o[2] / 2, t = o[1], s = l > 0, z, u, r, x = [[], []], y, A, E, D, J, C = [0, 0, 0, 0], K = function (a, b) {
            return b.y - a.y
        };
        if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                if (I) {
                    ...
                    if (l > 0) {
                        ...
                        for (J = 0; J < I; J++) {
                            ...
                            if (F < J && G[J] !== null)F = J; else for (u < I - J + F && G[J] !== null &&
                                                                        (F = u - I + J); G[F] === null;)F++;
                            L.push({i: F, y: G[F]});
                            G[F] = null
                        }
                    ...
                    for (J = 0; J < I; J++) {
                        ...
                        z._attr = {visibility: E, align: r[6]};
                        z._pos = {x: y + e.x + ({left: f, right: -f}[r[6]] || 0), y: A + e.y - 10};
                        z.connX = y;
                        z.connY = A;
            ...
            if (Fa(C) === 0 || this.verifyDataLabelOverflow(C))this.placeDataLabels(), s && g && n(this.points, function (b) {
                j = b.connector;
                r = b.labelPos;
                if ((z = b.dataLabel) && z._pos)E = z._attr.visibility, y = z.connX, A = z.connY, k = m ? ["M", y + (r[6] === "left" ? 5 : -5), A, "C", y, A, 2 * r[2] - r[4], 2 * r[3] - r[5], r[2], r[3], "L", r[4], r[5]] : ["M", y + (r[6] === "left" ? 5 : -5), A, "L", r[2], r[3], "L", r[4], r[5]], j ? (j.animate({d: k}), j.attr("visibility", E)) :
    ...
    var jb = A.TrackerMixin = {
        drawTrackerPoint: function () {
            ...
            var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath :
                a.graphPath), e = d.length, f = a.chart, g = f.pointer, h = f.renderer, i = f.options.tooltip.snap, j = a.tracker, k = b.cursor, m = k && {cursor: k}, k = a.singlePoints, l, o = function () {
    ...
    x(Pa.prototype, {
        ...
        zoomOut: function () {
            ...
            n(b === "xy" ? [1, 0] : [1], function (b) {
                ...
                if (h.series.length && (i || m > B(k.dataMin, k.min)) && (!i || j < v(k.dataMax, k.max)))h.setExtremes(m, j, !1, !1, {trigger: "pan"}), e = !0;
    ...
    x(Ca.prototype, {
        select: function (a, b) {
            ...
            var c = this.plotX, d = this.plotY, e = this.series, f = e.options.states, g = U[e.type].marker && e.options.marker, h = g && !g.enabled, i = g && g.states[a], j = i && i.enabled === !1, k = e.stateMarkerGraphic, m = this.marker || {}, l = e.chart, o = e.halo, q, a = a || "";
    ...
    R(I.prototype, "getTimeTicks", function (a, b, c, d, e, f, g, h) {
        var i = 0, j = 0, k, m = {}, l, o, q, t = [], n = -Number.MAX_VALUE, p = this.options.tickPixelInterval;
    ...
    R(Pa.prototype, "pan", function (a, b) {
        ...
        if (c.options.ordinal && c.series.length) {
            var f = this.mouseDownX, g = c.getExtremes(), h = g.dataMax, i = g.min, j = g.max, k = this.hoverPoints, m = c.closestPointRange,
                f = (f - d) / (c.translationSlope * (c.ordinalSlope || m)), l = {ordinalPositions: c.getExtendedPositions()}, m = c.lin2val, o = c.val2lin, q;
            if (l.ordinalPositions) {
                if (Q(f) > 1)k && n(k, function (a) {
                    a.setState()
                }), f < 0 ? (k = l, q = c.ordinalPositions ? c : l) : (k = c.ordinalPositions ? c : l, q = l), l = q.ordinalPositions, h > l[l.length - 1] && l.push(h), this.fixedRange = j - i, f = c.toFixedRange(null, null, m.apply(k, [o.apply(k, [i, !0]) + f, !0]), m.apply(q, [o.apply(q, [j, !0]) + f, !0])), f.min >= B(g.dataMin, i) && f.max <= v(h, j) && c.setExtremes(f.min, f.max, !0, !1, {trigger: "pan"}),
                    this.mouseDownX = d, L(this.container, {cursor: "move"})
            } else e = !0
        } else e = !0;
    ...
    (function (a) {
        ...
        var c = a.pick,
            d = a.wrap, e = a.extend, f = HighchartsAdapter.fireEvent, g = a.Axis, h = a.Series;
        e(g.prototype, {
        ...
        d(g.prototype, "init", function (a, b, c) {
            ...
            if (this.options.breaks) {
                ...
                this.val2lin = function (a) {
                    ...
                    else if (c.from >= a)break; else if (d.isInBreak(c, a)) {
                        b -= a - c.from;
                        break
                    }
                    return b
    ...
    var da = O.prototype, N = Kb.prototype, ic = da.processData, jc = da.generatePoints, kc = da.destroy, lc = N.tooltipFooterHeaderFormatter, mc = {
    ...
    }, Xb = [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1]], ["week", [1]], ["month", [1, 3, 6]], ["year", null]], Qa = {
        sum: function (a) {
            var b = a.length, c;
    ...
    da.groupData = function (a, b, c, d) {
        var e = this.data, f = this.options.data, g = [], h = [], i = a.length, j, k, m = !!b, l = [[], [], [], []], d = typeof d === "function" ? d : Qa[d], o = this.pointArrayMap, q = o && o.length, n;
        for (n = 0; n <= i; n++)if (a[n] >= c[0])break;
        for (; n <= i; n++) {
            for (; c[1] !== s && a[n] >= c[1] || n === i;)if (j = c.shift(), k = d.apply(0, l), k !== s && (g.push(j), h.push(k)), l[0] = [], l[1] = [], l[2] = [], l[3] = [], n === i)break;
            if (n === i)break;
            if (o) {
                j = this.cropStart + n;
                j = e && e[j] ||
                    this.pointClass.prototype.applyOptions.apply({series: this}, [f[j]]);
                var p;
    ...
    da.processData = function () {
        ...
        if (ic.apply(this, arguments) !== !1 && d) {
            ...
            if (j) {
                e = !0;
                this.points = null;
                var k = a.getExtremes(), d = k.min, k = k.max, i = i && a.getGroupIntervalFactor(d, k, this) || 1, h = j * (k - d) / h * i, j = a.getTimeTicks(a.normalizeTimeTickInterval(h, c.units || Xb), d, k, a.options.startOfWeek, f, this.closestPointRange), g = da.groupData.apply(this, [f, g, j, c.approximation]), f = g[0], g = g[1];
                if (c.smoothed) {
                    c = f.length -
                        1;
        ...
        drawPoints: function () {
            ...
            n(a.points, function (k) {
                if (k.plotY !== s)i = k.graphic, c = k.pointAttr[k.selected ? "selected" : ""] || a.pointAttr[""], f = c["stroke-width"] % 2 / 2, j = w(k.plotX) - f, g = w(k.shapeArgs.width / 2), h = ["M", j, w(k.yBottom), "L", j, w(k.plotY)], k.open !== null && (d = w(k.plotOpen) + f, h.push("M", j, d, "L", j - g, d)), k.close !== null && (e = w(k.plotClose) +
                    f, h.push("M", j, e, "L", j + g, e)), i ? i.attr(c).animate({d: h}) : k.graphic = b.renderer.path(h).attr(c).add(a.group)
            })
        },
        animate: null
    });
    ...
    N = ja(N, {
        ...
        getAttribs: function () {
            ...
            var a = this.options, b = a.states,
                c = a.upLineColor || a.lineColor, d = b.hover.upLineColor || c, e = b.select.upLineColor || c;
            n(this.points, function (a) {
        ...
        drawPoints: function () {
            ...
            n(a.points, function (n) {
                ...
                if (n.plotY !== s)c = n.pointAttr[n.selected ? "selected" : ""] || d, k = c["stroke-width"] % 2 / 2, m = w(n.plotX) - k, e = n.plotOpen, f = n.plotClose, g = X.min(e, f), h = X.max(e, f), q = w(n.shapeArgs.width / 2),
                    i = w(g) !== w(n.plotY), j = h !== n.yBottom, g = w(g) + k, h = w(h) + k, o = ["M", m - q, h, "L", m - q, g, "L", m + q, g, "L", m + q, h, "Z", "M", m, g, "L", m, i ? w(n.plotY) : g, "M", m, h, "L", m, j ? w(n.yBottom) : h], l ? l.attr(c).animate({d: o}) : n.graphic = b.renderer.path(o).attr(c).add(a.group).shadow(a.options.shadow)
            })
        }
    });
    K.candlestick = N;
    ...
    K.flags = ja(K.column, {
        ...
        translate: function () {
            ...
            var a = this.chart, b = this.points, c = b.length - 1, d, e, f = this.options.onSeries, f = (d = f && a.get(f)) && d.options.step,
                g = d && d.points, h = g && g.length, i = this.xAxis, j = i.getExtremes(), k, m, l;
            if (d && d.visible && h) {
        ...
        drawPoints: function () {
            var a, b = this.pointAttr[""], c = this.points, d = this.chart.renderer, e, f, g = this.options, h = g.y, i, j, k, m, l = g.lineWidth % 2 / 2, o, n;
            for (j = c.length; j--;)if (k = c[j], a = k.plotX > this.xAxis.len, e = k.plotX + (a ? l : -l), m = k.stackIndex, i = k.options.shape || g.shape, f = k.plotY, f !== s && (f = k.plotY + h + l - (m !== s && m * g.stackDistance)), o = m ? s : k.plotX + l, n = m ? s : k.plotY, m = k.graphic, f !== s && e >= 0 && !a)a = k.pointAttr[k.selected ?
                    "select" : ""] || b, m ? m.attr({
                x: e,
                y: f,
                r: a.r,
        ...
        drawHandle: function (a, b) {
            ...
            if (!isNaN(a)) {
                ...
                if (!(m.translate(d, !0) - m.translate(c, !0) < e.xAxis[0].minRange)) {
                    ...
                    if (A) {
                        this.leftShade[e](r.maskInside ? {x: g + b, y: y, width: c - b, height: x} : {
                            x: g,
                            y: y,
                            width: b,
                            height: x
                        ...
                        if (this.rightShade)this.rightShade[e]({
                            x: g +
                            c, y: y, width: h - c, height: x
                        });
                        this.outline[e]({d: ["M", i, F, "L", g + b - C, F, g + b - C, F + J, "L", g + c - C, F + J, "L", g + c - C, F, i + j, F].concat(r.maskInside ? ["M", g + b + C, F, "L", g + c - C, F] : [])});
                    ...
                    if (t && k)this.drawScrollbarButton(0), this.drawScrollbarButton(1), k[e]({
                        translateX: i,
                        translateY: w(F + x)
                    }), o[e]({width: j}), g = n + b, h = a - G, h < u && (D = (u - h) / 2, h = u, g -= D), this.scrollbarPad = D, l[e]({
                        x: W(g) + G % 2 / 2,
                        width: h
            ...
            a.mouseDownHandler = function (d) {
                var d = b.pointer.normalize(d), e = a.zoomedMin, f = a.zoomedMax, h = a.top, j = a.scrollbarHeight, k = a.scrollerLeft, m = a.scrollerWidth, l = a.navigatorLeft, n = a.navigatorWidth, p = a.scrollbarPad, r = a.range, s = d.chartX, v = d.chartY, d = b.xAxis[0], w, x = fb ? 10 : 7;
                if (v > h && v < h + g + j)if ((h =
                        !a.scrollbarEnabled || v < h + g) && X.abs(s - e - l) < x)a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null; else if (h && X.abs(s - f - l) < x)a.grabbedRight = !0, a.otherHandlePos = e, a.fixedExtreme = d.min, b.fixedRange = null; else if (s > l + e - p && s < l + f + p)a.grabbedCenter = s, a.fixedWidth = r, i = s - e; else if (s > k && s < k + m) {
            ...
            if (a && this.navigatorOptions.adaptToUpdatedData !== !1)E(a, "updatedData", this.updatedDataHandler), a.userOptions.events = x(a.userOptions.event, {updatedData: this.updatedDataHandler})
        }, updatedDataHandler: function () {
            var a = this.chart.scroller, b = a.baseSeries, c = b.xAxis, d = c.getExtremes(), e = d.min, f = d.max, g = d.dataMin, d = d.dataMax, h = f - e, i, j, k, m, l, n = a.series;
            i = n.xData;
            var p = !!c.setExtremes;
            ...
            j && (k = d, i || (m = v(k -
                h, n.xData[0])));
            p && (i || j) ? isNaN(m) || c.setExtremes(m, k, !0, !1, {trigger: "updatedData"}) : (l && this.chart.redraw(!1), a.render(v(e, g), B(f, d)))
        }, destroy: function () {
            this.removeEvents();
    ...
    P.lang = y(P.lang, {rangeSelectorZoom: "Zoom", rangeSelectorFrom: "From", rangeSelectorTo: "To"});
    Fb.prototype = {
        clickButton: function (a, b) {
            var c = this, d = c.selected, e = c.chart, f = c.buttons, g = c.buttonOptions[a], h = e.xAxis[0], i = e.scroller && e.scroller.getUnionExtremes() || h || {}, j = i.dataMin, k = i.dataMax, m, l = h && w(B(h.max, p(k, h.max))), o = new fa(l), q = g.type, t = g.count,
                i = g._range, r, x = g.dataGrouping;
            if (!(j === null || k === null || a === c.selected)) {
                if (x)this.forcedDataGrouping = !0, I.prototype.setDataGrouping.call(h || {chart: this.chart}, x, !1);
                if (q === "month" || q === "year")m = {
                    month: "Month",
                    year: "FullYear"
                }[q], o["set" + m](o["get" + m]() - t), m = o.getTime(), j = p(j, Number.MIN_VALUE), isNaN(m) || m < j ? (m = j, l = B(m + i, k)) : i = l - m; else if (i)m = v(l - i, j), l = B(m + i, k); else if (q === "ytd")if (h) {
                ...
                }) : (d = e.options.xAxis, d[0] = y(d[0], {range: i, min: r}));
                c.setSelected(a)
            }
            ...
            var b = this, c = this.chart, d = c.xAxis[0], e = c.scroller && c.scroller.getUnionExtremes() || d, f = e.dataMin, g = e.dataMax, h = b.selected, i = b.options.allButtonsEnabled, j =
                b.buttons;
            a && c.fixedRange !== w(d.max - d.min) && (j[h] && j[h].setState(0), b.setSelected(null));
            n(b.buttonOptions, function (a, c) {
                var e = a._range, n = e > g - f, p = e < d.minRange, r = a.type === "all" && d.max - d.min >= g - f && j[c].state !== 2, s = a.type === "ytd" && ka("%Y", f) === ka("%Y", g);
            ...
            L(this[a + "Input"], {
                left: b.translateX + c.x + "px", top: b.translateY + "px",
                width: c.width - 2 + "px", height: c.height - 2 + "px", border: "2px solid silver"
            })
            ...
            var b = this, c = b.chart, d = c.renderer.style, e = c.renderer, f = c.options.rangeSelector, g = b.div, h = a === "min", i, j, k = this.inputGroup;
            this[a + "Label"] = j = e.label(P.lang[h ? "rangeSelectorFrom" : "rangeSelectorTo"], this.inputGroup.offset).attr({padding: 2}).css(y(d, f.labelStyle)).add(k);
            k.offset += j.width + 5;
            ...
            this[a + "Input"] = i = aa("input", {name: a, className: "highcharts-range-selector", type: "text"}, x({
            ...
            i.onchange = function () {
                ...
                isNaN(d) || (P.global.useUTC || (d += (new fa).getTimezoneOffset() * 6E4), h ? d > b.maxInput.HCTime ? d = s : d < g && (d = g) : d < b.minInput.HCTime ? d = s : d > j && (d = j), d !== s && c.xAxis[0].setExtremes(h ? d : e.min,
                    h ? e.max : d, s, s, {trigger: "rangeSelectorInput"}))
            }
        }, render: function (a, b) {
            var c = this, d = c.chart, e = d.renderer, f = d.container, g = d.options, h = g.exporting && g.navigation && g.navigation.buttonOptions, i = g.rangeSelector, j = c.buttons, k = P.lang, g = c.div, g = c.inputGroup, m = i.buttonTheme, l = i.buttonPosition || {}, o = i.inputEnabled, q = m && m.states, t = d.plotLeft, s, v, u = c.group;
    ...
    R(I.prototype, "getPlotLinePath", function (a, b, c, d, e, f) {
        var g = this, h = this.isLinked && !this.series ? this.linkedParent.series : this.series, i = g.chart, j = i.renderer, k = g.left, m = g.top, l, o, q, s, x = [], y = [], u;
        ...
        n(g.isXAxis ? i.yAxis : i.xAxis, function (a) {
            if (r(a.options.id) ?
                ...
                var b = a.isXAxis ? "yAxis" : "xAxis", b = r(a.options[b]) ? i[b][a.options[b]] : i[b][0];
                g === b && y.push(a)
            }
        });
    ...
    R(I.prototype, "drawCrosshair", function (a, b, c) {
        ...
        if (r(this.crosshair.label) && this.crosshair.label.enabled && r(c)) {
            var a = this.chart, f =
                this.options.crosshair.label, g = this.isXAxis ? "x" : "y", b = this.horiz, h = this.opposite, i = this.left, j = this.top, k = this.crossLabel, m, l, n = f.format, q = "";
    ...
    var nc = da.init, oc = da.processData, pc = Ca.prototype.tooltipFormatter;
    da.init = function () {
    ...
    R(O.prototype, "render", function (a) {
        if (this.chart.options._stock)!this.clipBox && this.animate && this.animate.toString().indexOf("sharedClip") !== -1 ? (this.clipBox = y(this.chart.clipBox), this.clipBox.width = this.xAxis.len, this.clipBox.height = this.yAxis.len) : this.chart[this.sharedClipKey] && (ab(this.chart[this.sharedClipKey]), this.chart[this.sharedClipKey].attr({
