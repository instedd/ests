...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header modal-header-primary">
            ...
            <h3><i class="fa fa-plus m-r-5"></i> Update Reference Lab</h3>
        </div>
        <div class="modal-body">
            <div class="row">   
                <div class="col-md-12">
                    ...
                    echo form_open_multipart("UserAdministration/updateLab", $attributes); ?>
                    <fieldset id="update_lab_container">
                        <?php
                        $i = 1;
                        $app = 1;
                        foreach ($all_lab_details as $row_lab) {
                            $html .= '
                            ...
                            <div class="col-md-12 form-group user-form-group">
                                <div class="pull-right">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-sm">Update Lab</button>
                                </div>
                            </div>
                        ';
                        }
