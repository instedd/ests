...
$html .= '<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">';
$attributes = array("id" => "delete_labs_form", "name" => "delete_labs_form");
echo form_open("UserAdministration/deleteLab", $attributes);
$html .= '
                    <fieldset>
                        <div class="col-md-12 form-group user-form-group">
                            ...
                            <div class="pull-right">
                                <a href="' . site_url('' . $current_class . '/manage_labs') . '" class="btn btn-danger btn-sm">NO</a>
