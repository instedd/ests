...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header modal-header-primary">
            ...
            <h3><i class="fa fa-plus m-r-5"></i> Update Received Sample</h3>
        </div>
        <div class="modal-body">
            <div class="row">   
                <div class="col-md-12">
                    ...
                    echo form_open_multipart("SampleTracking/update_recsample", $attributes); ?>
                    <fieldset id="update_disease_container">
                        <?php
                        foreach ($all_rec_sample_details as $row_sample) {
                            $html .= '
                            ...
                            <div class="col-md-6 form-group">
                                <label class="control-label" for="sample_status">Sample Status</label>';
                                $attrib_role = 'class = " form-control" name="facility_code" id = "sample_status" required';
                               $html .=form_dropdown('sample_status', $sample_status, $row_sample->sample_status, $attrib_role);
                            ...
                            <div class="col-md-6 form-group">
                                <label class="control-label" for="dateReceived">Date of Sample Receiving</label>
                          
                                <div class="input-group date">
                                <input name="dateReceived" id="datepicker"
                                       type="text"
                                       class="datepicker"
                                       value="'.$row_sample->date_received.'" required/>
                                <span class="text-danger help-block small with-errors">
                                        </span>
                               </div>
                            </div>
