<div class="modal-dialog modal-dialog ">
        <div class="modal-content">
            <div class="modal-header modal-header-primary">
                ...
                <h3><i class="fa fa-plus m-r-5"></i> Add New Reference Lab</h3>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        echo form_open("UserAdministration/addLab", $attributes); ?>
                        <fieldset>
                            <div class="col-md-6 form-group">
                                <label class="control-label" for="role_name">Reference Lab Name</label>
                                <input name="name" id="name"
                                       type="text" placeholder="Enter reference Lab"
                                       class="form-control"
                            ...
                            <div class="col-md-12 form-group user-form-group">
                                <div class="pull-right">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-sm">Add Lab</button>
                                </div>
                            </div>
                        </fieldset>
                        <?= form_close(); ?>
