(function (h) {
    ...
    n(j.prototype, "init", function (g, d, a) {
        ...
        if (this.options.breaks) {
            ...
            this.lin2val = function (b) {
                var e, a;
                for (a = 0; a < c.breakArray.length; a++)if (e = c.breakArray[a], e.from >= b)break; else e.to < b ? b += e.to - e.from : c.isInBreak(e, b) && (b += e.to - e.from);
                return b
            };
            ...
            this.setAxisTranslation = function (b) {
                ...
                for (m in a) {
                    ...
                    for (; i < k;)i += h;
                    for (; i < l; i += h)b.push({value: i, move: "in"}), b.push({
                        value: i + (f.to - f.from),
                        move: "out",
                        size: f.breakSize
                    })
                ...
                for (m in b) {
                    ...
                    a === 0 && (d.push({
                        from: i,
                        to: f.value,
                        len: f.value - i - (f.size || 0)
                    }), g += f.value - i - (f.size || 0))
                }
                c.breakArray = d;
                o(c, "afterBreaks");
    ...
    n(h.seriesTypes.column.prototype, "drawPoints", function (g) {
        ...
        for (e = 0; e < g.length; e++) {
            c = g[e];
            j = c.stackY || c.y;
            for (h = 0; h < a.length; h++)if (b = a[h], j < b.from)break; else j > b.to ? o(d, "pointBreak", {
                point: c,
                brk: b
            }) : o(d, "pointInBreak", {point: c, brk: b})
        }
    })
})(Highcharts);
