...
(function (d) {
    ...
    var o = Math.PI, A = o / 180, m = Math.sin, n = Math.cos, z = d.pick, H = Math.round;
    d.perspective = p;
    ...
    d.SVGRenderer.prototype.cuboid = function (c) {
        ...
        b.animate = function (a, b, c) {
            B(a.x) && B(a.y) ? (a = this.renderer.cuboidPath(a), this.front.attr({zIndex: a[3]}).animate({d: a[0]},
                b, c), this.top.attr({zIndex: a[4]}).animate({d: a[1]}, b, c), this.side.attr({zIndex: a[5]}).animate({d: a[2]}, b, c)) : a.opacity ? (this.front.animate(a, b, c), this.top.animate(a, b, c), this.side.animate(a, b, c)) : d.SVGElement.prototype.animate.call(this, a, b, c);
            return this
        };
        b.destroy = function () {
            this.front.destroy();
    ...
    d.SVGRenderer.prototype.cuboidPath = function (c) {
        var b = c.x, a = c.y, e = c.z, g = c.height, f = c.width, h = c.depth, j = d.map, i = [{
            x: b, y: a,
            z: e
        }, {x: b + f, y: a, z: e}, {x: b + f, y: a + g, z: e}, {x: b, y: a + g, z: e}, {
            x: b,
            y: a + g,
            z: e + h
        }, {x: b + f, y: a + g, z: e + h}, {x: b + f, y: a, z: e + h}, {
            x: b,
            y: a,
            z: e + h
        }], i = p(i, d.charts[this.chartIndex], c.insidePlotArea), a = function (a, b) {
            a = j(a, function (a) {
                return i[a]
            });
            b = j(b, function (a) {
        ...
        }, c = a([3, 2, 1, 0], [7, 6, 5, 4]), b = a([1, 6, 7, 0], [4, 5, 2, 3]), a = a([1, 2, 5, 6], [0, 7, 4, 3]);
    ...
    d.SVGRenderer.prototype.arc3d = function (c) {
        c.alpha *=
            A;
        c.beta *= A;
        var b = this.g(), a = this.arc3dPath(c), e = b.renderer, g = a.zTop * 100;
        b.shapeArgs = c;
        b.top = e.path(a.top).setRadialReference(c.center).attr({zIndex: a.zTop}).add(b);
        b.side1 = e.path(a.side2).attr({zIndex: a.zSide1});
        b.side2 = e.path(a.side1).attr({zIndex: a.zSide2});
        b.inn = e.path(a.inn).attr({zIndex: a.zInn});
        b.out = e.path(a.out).attr({zIndex: a.zOut});
        b.fillSetter = function (a) {
            this.color = a;
    ...
    d.SVGRenderer.prototype.arc3dPath = function (c) {
        ...
        var a = c.x, e = c.y, d = c.start, f = c.end - 1.0E-5, h = c.r, j = c.innerR, i = c.depth, k = c.alpha, l = c.beta, q = n(d), p = m(d), c = n(f), x = m(f), r = h * n(l);
        h *= n(k);
        var v = j * n(l), t = j * n(k), j = i * m(l), u = i * m(k), i = ["M", a + r * q, e + h * p], i = i.concat(s(a, e, r, h, d, f, 0, 0)), i = i.concat(["L", a + v * c, e + t * x]), i = i.concat(s(a, e, v, t, f, d, 0, 0)), i = i.concat(["Z"]), y = l > 0 ? o / 2 : 0, l = k > 0 ? 0 : o / 2, y = d > -y ? d : f > -y ? -y : d, w = f < o -
        l ? f : d < o - l ? o - l : f, k = ["M", a + r * n(y), e + h * m(y)], k = k.concat(s(a, e, r, h, y, w, 0, 0));
    ...
    d.Chart.prototype.retrieveStacks = function (c) {
        ...
        d.each(this.series, function (d) {
            ...
            a[e] ? a[e].series.push(d) : (a[e] = {series: [d], position: g}, g++)
        });
        a.totalStacks = g + 1;
        return a
    };
    ...
    d.wrap(d.Axis.prototype, "render", function (c) {
        c.apply(this, [].slice.call(arguments, 1));
        if (this.chart.is3d()) {
            var b = this.chart, a = b.renderer, e = b.options.chart.options3d, d = e.frame, f = d.bottom, h = d.back, d = d.side, j = e.depth, i = this.height, k = this.width, l = this.left, q = this.top;
    ...
    d.wrap(d.Axis.prototype, "getPlotLinePath", function (c) {
        ...
        if (b === null)return b;
        var a = this.chart.options.chart.options3d, a = this.isZAxis ? this.chart.plotWidth : a.depth, d = this.opposite;
        this.horiz && (d = !d);
        b = [this.swapZ({
            x: b[1], y: b[2],
            z: d ? a : 0
        }), this.swapZ({x: b[1], y: b[2], z: a}), this.swapZ({x: b[4], y: b[5], z: a}), this.swapZ({
            x: b[4],
            y: b[5],
            z: d ? 0 : a
        })];
    ...
    d.wrap(d.Tick.prototype, "getLabelPosition", function (c) {
        var b = c.apply(this, [].slice.call(arguments, 1));
        if (!this.axis.chart.is3d())return b;
        var a = p([this.axis.swapZ({x: b.x, y: b.y, z: 0})], this.axis.chart, !1)[0];
    ...
    d.wrap(d.Axis.prototype, "getTitlePosition", function (c) {
        var b = c.apply(this, [].slice.call(arguments, 1));
        return !this.chart.is3d() ? b : b = p([this.swapZ({x: b.x, y: b.y, z: 0})], this.chart, !1)[0]
    });
    ...
    d.extend(E.prototype, {
        setOptions: function (c) {
            ...
            d.each(c.series, function (a) {
                if (a.visible || !b.options.chart.ignoreHiddenSeries)if (c.hasVisibleSeries = !0, a = a.zData, a.length)c.dataMin = Math.min(z(c.dataMin, a[0]), Math.min.apply(null, a)), c.dataMax = Math.max(z(c.dataMax, a[0]), Math.max.apply(null, a))
            })
        }
    });
    ...
    d.wrap(d.seriesTypes.column.prototype, "translate", function (c) {
        ...
        if (this.chart.is3d()) {
            var b = this.chart,
                a = this.options, e = a.depth || 25, g = (a.stacking ? a.stack || 0 : this._i) * (e + (a.groupZPadding || 1));
            a.grouping !== !1 && (g = 0);
            g += a.groupZPadding || 1;
    ...
    d.wrap(d.seriesTypes.column.prototype, "animate", function (c) {
        if (this.chart.is3d()) {
            var b = arguments[1], a = this.yAxis, e = this, g = this.yAxis.reversed;
    ...
    d.wrap(d.seriesTypes.column.prototype, "init", function (c) {
        ...
        if (this.chart.is3d()) {
            var b = this.options, a = b.grouping, d = b.stacking, g = 0;
            if (a === void 0 || a) {
                a = this.chart.retrieveStacks(d);
                d = b.stack || 0;
                for (g = 0; g < a[d].series.length; g++)if (a[d].series[g] === this)break;
    ...
    d.wrap(d.Series.prototype, "alignDataLabel", function (c) {
        if (this.chart.is3d() && (this.type === "column" || this.type === "columnrange")) {
            var b = arguments[4], a = {x: b.x, y: b.y, z: this.z}, a = p([a], this.chart, !0)[0];
            b.x = a.x;
            b.y =
                a.y
        }
    ...
    d.wrap(d.seriesTypes.pie.prototype, "translate", function (c) {
        c.apply(this, [].slice.call(arguments, 1));
        if (this.chart.is3d()) {
            var b = this, a = b.chart, e = b.options, g = e.depth || 0, f = a.options.chart.options3d, h = {
                x: a.plotWidth / 2,
                y: a.plotHeight / 2,
                z: f.depth
            }, j = f.alpha, i = f.beta, k = e.stacking ? (e.stack || 0) * g : b._i * g;
            k += g / 2;
            e.grouping !== !1 && (k = 0);
    ...
    d.wrap(d.seriesTypes.pie.prototype, "drawDataLabels", function (c) {
        if (this.chart.is3d()) {
            ...
            d.each(b.data,
                function (a) {
                    var c = a.shapeArgs, d = c.r, f = c.depth, h = (c.alpha || b.chart.options.chart.options3d.alpha) * A, c = (c.start + c.end) / 2, a = a.labelPos;
    ...
    d.wrap(d.seriesTypes.pie.prototype, "animate", function (c) {
        if (this.chart.is3d()) {
            var b =
                arguments[1], a = this.options.animation, e = this.center, g = this.group, f = this.markerGroup;
            if (d.svg)if (a === !0 && (a = {}), b) {
