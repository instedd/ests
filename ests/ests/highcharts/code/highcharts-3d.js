...
(function (D) {
    ...
    (function (a) {
        ...
        a.perspective = function (p, n, u) {
            var m = n.options.chart.options3d, f = u ? n.inverted : !1, g = n.plotWidth / 2, r = n.plotHeight / 2, d = m.depth / 2, e = k(m.depth, 1) * k(m.viewDistance, 0), c = n.scale3d || 1, b = q * m.beta * (f ? -1 : 1), m = q * m.alpha * (f ? -1 : 1), h = Math.cos(m), v = Math.cos(-b), x = Math.sin(m), y = Math.sin(-b);
            ...
            return a.map(p, function (b) {
                ...
                a = a * n * c + g;
                b = b * n * c + r;
                return {x: f ? b : a, y: f ? a : b, z: m * c + d}
            })
        };
    ...
    (function (a) {
        ...
        var n = Math.cos, u = Math.PI, m = Math.sin, f = a.animObject, g = a.charts, r = a.color, d = a.defined, e = a.deg2rad, c = a.each, b = a.extend, h = a.inArray, v = a.map, x = a.merge, y = a.perspective, E = a.pick, A = a.SVGElement, G = a.SVGRenderer, B = a.wrap, t = 4 * (Math.sqrt(2) - 1) / 3 / (u / 2);
        ...
        G.prototype.cuboid = function (b) {
            ...
            c.animate = function (b, c, a) {
                d(b.x) && d(b.y) ? (b = this.renderer.cuboidPath(b), this.front.attr({zIndex: b[3]}).animate({d: b[0]}, c, a), this.top.attr({zIndex: b[4]}).animate({d: b[1]}, c, a), this.side.attr({zIndex: b[5]}).animate({d: b[2]}, c, a),
                    this.attr({zIndex: -b[6]})) : b.opacity ? (this.front.animate(b, c, a), this.top.animate(b, c, a), this.side.animate(b, c, a)) : A.prototype.animate.call(this, b, c, a);
                return this
            };
            c.destroy = function () {
                this.front.destroy();
        ...
        G.prototype.cuboidPath = function (b) {
            ...
            var a = b.x, h = b.y, d = b.z, e = b.height, f = b.width, r = b.depth, m = [{x: a, y: h, z: d}, {
                x: a + f,
                y: h,
                z: d
            }, {x: a + f, y: h + e, z: d}, {x: a, y: h + e, z: d}, {x: a, y: h + e, z: d + r}, {
                x: a + f, y: h +
                e, z: d + r
            }, {x: a + f, y: h, z: d + r}, {
                x: a,
                y: h,
                z: d + r
            }], m = y(m, g[this.chartIndex], b.insidePlotArea), d = function (b, a) {
                var h = [];
                b = v(b, c);
                a = v(a, c);
                0 > q(b) ? h = b : 0 > q(a) && (h = a);
        ...
        a.SVGRenderer.prototype.arc3d = function (a) {
            ...
            var l = this.g(),
                m = l.renderer, v = "x y r innerR start end".split(" ");
            a = x(a);
            a.alpha *= e;
            a.beta *= e;
            l.top = m.path();
            ...
            l.setPaths = function (b) {
                var a = l.renderer.arc3dPath(b), c = 100 * a.zTop;
                l.attribs = b;
                l.top.attr({d: a.top, zIndex: a.zTop});
                l.inn.attr({d: a.inn, zIndex: a.zInn});
                l.out.attr({d: a.out, zIndex: a.zOut});
                l.side1.attr({d: a.side1, zIndex: a.zSide1});
                l.side2.attr({d: a.side2, zIndex: a.zSide2});
                l.zIndex = c;
                l.attr({zIndex: c});
            ...
            l.fillSetter = function (b) {
                ...
                this.fill = b;
                this.side1.attr({fill: a});
                this.side2.attr({fill: a});
                this.inn.attr({fill: a});
                this.out.attr({fill: a});
            ...
            c(["opacity", "translateX", "translateY", "visibility"], function (b) {
                l[b + "Setter"] = function (b, a) {
                    l[a] = b;
                    c(["out",
                        "inn", "side1", "side2", "top"], function (c) {
                        l[c].attr(a, b)
                    })
                }
            });
        ...
        G.prototype.arc3dPath = function (b) {
            ...
            var c = b.x, h = b.y, d = b.start, e = b.end - .00001, f = b.r, r = b.innerR, v = b.depth, g = b.alpha, k = b.beta, x = Math.cos(d), q = Math.sin(d);
            b = Math.cos(e);
            var y = Math.sin(e), w = f * Math.cos(k), f = f * Math.cos(g), t = r * Math.cos(k), B = r * Math.cos(g), r = v * Math.sin(k), z = v * Math.sin(g), v = ["M", c + w * x, h + f * q], v = v.concat(p(c, h, w, f, d, e, 0, 0)), v = v.concat(["L", c + t * b, h + B * y]), v = v.concat(p(c, h, t, B, e, d, 0, 0)), v = v.concat(["Z"]), E = 0 < k ? Math.PI / 2 : 0, k = 0 <
            g ? 0 : Math.PI / 2, E = d > -E ? d : e > -E ? -E : d, C = e < u - k ? e : d < u - k ? u - k : e, A = 2 * u - k, g = ["M", c + w * n(E), h + f * m(E)], g = g.concat(p(c, h, w, f, E, C, 0, 0));
    ...
    (function (a) {
        function q(a, d) {
            var e = a.plotLeft, c = a.plotWidth + e, b = a.plotTop, h = a.plotHeight + b, f = e + a.plotWidth / 2, g = b + a.plotHeight / 2, r = Number.MAX_VALUE, m = -Number.MAX_VALUE, k = Number.MAX_VALUE, n = -Number.MAX_VALUE, q, t = 1;
            q = [{x: e, y: b, z: 0}, {x: e, y: b, z: d}];
            p([0, 1],
                function (b) {
                    q.push({x: c, y: q[b].y, z: q[b].z})
                });
            p([0, 1, 2, 3], function (b) {
                q.push({x: q[b].x, y: h, z: q[b].z})
            });
            q = u(q, a, !1);
            p(q, function (b) {
                r = Math.min(r, b.x);
        ...
        var k = a.Chart, p = a.each, n = a.merge, u = a.perspective, m = a.pick, f = a.wrap;
        ...
        k.prototype.retrieveStacks = function (a) {
            ...
            p(this.series, function (h) {
                ...
                e[c] ? e[c].series.push(h) : (e[c] = {series: [h], position: b}, b++)
            });
            e.totalStacks = b + 1;
            return e
        }
    ...
    (function (a) {
        var q,
            k = a.Axis, p = a.Chart, n = a.each, u = a.extend, m = a.merge, f = a.perspective, g = a.pick, r = a.splat, d = a.Tick, e = a.wrap;
        ...
        e(k.prototype, "render", function (a) {
            ...
            if (this.chart.is3d()) {
                ...
                }).add(), this.bottomFrame.attr({fill: f.color || "none", stroke: f.color || "none"}))) : (d = {
        ...
        e(k.prototype, "getPlotBandPath", function (a) {
            ...
            var b = arguments, c = b[1], b = this.getPlotLinePath(b[2]);
        ...
        e(d.prototype, "getLabelPosition", function (a) {
            var b = a.apply(this, [].slice.call(arguments, 1));
            this.axis.chart.is3d() && (b = f([this.axis.swapZ({x: b.x, y: b.y, z: 0})], this.axis.chart, !1)[0]);
            return b
        });
        a.wrap(k.prototype, "getTitlePosition", function (a) {
            var b = this.chart.is3d(), c, d;
    ...
    (function (a) {
        ...
        var p = a.each, n = a.perspective,
            u = a.pick, m = a.Series, f = a.seriesTypes, g = a.svg;
        a = a.wrap;
        a(f.column.prototype, "translate", function (a) {
            ...
            if (this.chart.is3d()) {
                ...
                p(this.data, function (a) {
                    if (null !== a.y) {
                        var e = a.shapeArgs, h = a.tooltipPos;
                        a.shapeType = "cuboid";
                        e.z = b;
                        e.depth = c;
                        e.insidePlotArea = !0;
                        h = n([{x: h[0], y: h[1], z: b}], d, !0)[0];
        ...
        a(m.prototype, "alignDataLabel", function (a) {
            if (this.chart.is3d() && ("column" === this.type || "columnrange" === this.type)) {
                var d = arguments[4], e = {x: d.x, y: d.y, z: this.z}, e = n([e], this.chart, !0)[0];
                d.x = e.x;
                d.y = e.y
            }
            a.apply(this, [].slice.call(arguments, 1))
    ...
    (function (a) {
        ...
        a(n.pie.prototype, "translate", function (a) {
            a.apply(this, [].slice.call(arguments, 1));
            if (this.chart.is3d()) {
                var f = this, g = f.options, m = g.depth || 0, d = f.chart.options.chart.options3d, e = d.alpha, c = d.beta, b = g.stacking ? (g.stack || 0) * m : f._i * m, b = b + m / 2;
                !1 !== g.grouping && (b = 0);
                k(f.data, function (a) {
                    var d = a.shapeArgs;
                    a.shapeType = "arc3d";
        ...
        a(n.pie.prototype, "drawDataLabels", function (a) {
            if (this.chart.is3d()) {
                ...
                k(this.data, function (a) {
                    var g = a.shapeArgs, d = g.r, e = (g.start + g.end) / 2, c = a.labelPos, b = -d * (1 - Math.cos((g.alpha || f.alpha) * q)) * Math.sin(e), h = d * (Math.cos((g.beta || f.beta) * q) - 1) * Math.cos(e);
                    k([0, 2, 4], function (a) {
                        c[a] += h;
                        c[a + 1] += b
                    })
        ...
        a(n.pie.prototype, "animate", function (a) {
            if (this.chart.is3d()) {
                var f = arguments[1], g = this.options.animation, k = this.center, d = this.group, e = this.markerGroup;
    ...
    (function (a) {
        ...
        u(n.scatter.prototype, "translate", function (a) {
            a.apply(this, [].slice.call(arguments, 1));
            if (this.chart.is3d()) {
                var f = this.chart, g = k(this.zAxis, f.options.zAxis[0]), m = [], d, e, c;
